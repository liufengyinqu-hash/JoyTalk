# NixOS module for JoyTalk speech-to-text
#
...
# Usage in your flake:
#
#   inputs.joytalk.url = "github:liufengyinqu-hash/JoyTalk";
#
#   nixosConfigurations.myhost = nixpkgs.lib.nixosSystem {
#     modules = [
#       joytalk.nixosModules.default
#       { programs.joytalk.enable = true; }
#     ];
#   };
{
  config,
...
let
  cfg = config.programs.joytalk;
in
{
  options.programs.joytalk = {
    enable = lib.mkEnableOption "JoyTalk offline speech-to-text";
