...
从 [GitHub Releases](https://github.com/liufengyinqu-hash/JoyTalk/releases) 下载最新版 DMG 文件（`JoyTalk_1.0.1_aarch64.dmg`），打开后拖入 Applications 文件夹即可。

本地构建的 DMG 文件位于：`target/release/bundle/dmg/JoyTalk_1.0.1_aarch64.dmg`
