; Custom NSIS template for JoyTalk with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\JoyTalk for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older JoyTalk releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "JoyTalk Portable Mode"
    FileClose $0
